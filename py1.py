...
if token_result and "access_token" in token_result:
    ...
    You must address {user_data['givenName']} queries while ensuring that no personal identifiable information (PII) of other employees is disclosed. If only current user is Mariyam or Mahesh, you can give other employee’s objectives, data, or personal information but
